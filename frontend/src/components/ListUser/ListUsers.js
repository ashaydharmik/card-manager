    ...
    <>
      ...
      <div className="filters-teams">
        ...
        <div className="teams">
          <button onClick={toggleSelectionMode}>
            {isSelectionMode ? "Cancel Selection" : "Create Teams"}
          </button>
      ...
      <section className="card-container">
        <div className="card-list">
          {isLoading ? (
            ...
            visibleUsers.map((user) => (
              <div
                className={`card ${
                  isSelectionMode && selectedUserId.includes(user.id)
                    ? "selected"
                    : ""
                }`}
                key={user.id}
        ...
        <div className="pagination">
          <button onClick={prevPage} id="btn">
            Prev
          </button>
          <p>
            {pages.map((page) => (
          ...
          <button onClick={nextPage} id="btn">
            Next
          </button>
        </div>
      </section>
